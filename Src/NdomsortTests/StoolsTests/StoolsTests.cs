namespace NdomsortTests.StoolsTests
{
    ...
    public class StoolsTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => Stools.FindLowMedian(new int[0] { }, Cmp.CmpByIComparable));
        }
        ...
        public void IsDominateNullPass1Test()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => Stools.IsDominate(null, seq, Cmp.CmpByIComparable));
        }
